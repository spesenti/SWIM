...
Visual display of the change of empirical distribution functions from the baseline to the two stressed models of X1, the portfolio component with the largest sensitivity.
