...
Visual display of the change of empirical distribution functions and denisty from the baseline to the two stressed models of X5, the portfolio component with the largest sensitivity.
